...
#Function 2; group_loaded_images
allows you to have all of your individula assigned images converted to a single list to streamline batch analysis 
```{r}
...
Allows you to analyze multiple images after you have optimized your thresholds, so that you can quantify mulpiple images at once for your data set AFTER YOU HAVE CREATED YOUR GROUPED IMAGES
